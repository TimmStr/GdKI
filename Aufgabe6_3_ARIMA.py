...
#Ist mittlerweile irrelevant, da es sich seit der Päsentation als falsches Werkzeug herausgestellt hat
#wenn ein Fehler beim Ausfüren auftritt,  am besten in Jupyter Notebook ausführen
...
def forecastAnalysisByColumn(data, name):
    ...
    # enter all variables including d manually if you are using auto_arima
    train, test = performARIMA(data, 14/15, p=4, d=d, q=0)

    # Plot der Trainingsdaten und Testdaten
...
# seasonalFactor equals m
def performARIMA(data, splitFactor, p, d, q):
